...
var G__18316 = cljs.core.next(xs);
var G__18317 = cljs.core.next(ys);
xs = G__18316;
ys = G__18317;
continue;
} else {
...
while(true){
if((n < cnt)){
var nval = (function (){var G__18261 = val;
var G__18262 = cicoll.cljs$core$IIndexed$_nth$arity$2(null,n);
...
while(true){
if((n < cnt)){
var nval = (function (){var G__18264 = val__$1;
var G__18265 = cicoll.cljs$core$IIndexed$_nth$arity$2(null,n);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__18264,G__18265) : f.call(null,G__18264,G__18265));
})();
if(cljs.core.reduced_QMARK_(nval)){
return cljs.core.deref(nval);
} else {
...
while(true){
if((n < cnt)){
var nval = (function (){var G__18271 = val__$1;
var G__18272 = cicoll.cljs$core$IIndexed$_nth$arity$2(null,n);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__18271,G__18272) : f.call(null,G__18271,G__18272));
})();
if(cljs.core.reduced_QMARK_(nval)){
return cljs.core.deref(nval);
} else {
...
var G__18333 = cljs.core.next(es);
var G__18334 = cljs.core._assoc_BANG_(tcoll__$1,cljs.core.key(e),cljs.core.val(e));
es = G__18333;
tcoll__$1 = G__18334;
continue;
} else {
...
var G__18338 = cljs.core._assoc(ret,cljs.core._nth(e,(0)),cljs.core._nth(e,(1)));
var G__18339 = cljs.core.next(es);
ret = G__18338;
es = G__18339;
continue;
} else {
