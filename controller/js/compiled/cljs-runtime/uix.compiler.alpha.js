...
return cljs.core.some((function (p1__17850_SHARP_){
if(clojure.string.starts_with_QMARK_(p1__17850_SHARP_,"G_")){
return (component_type === (component_type[p1__17850_SHARP_]));
} else {
return null;
}
...
if(cljs.core.truth_((function (){var and__5160__auto__ = cljs.core.not(component_type.uix_component_QMARK_);
...
var name_str_17937 = (function (){var or__5162__auto__ = component_type.displayName;
...
throw (new Error((""+"Invalid use of Reagent component "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(name_str_17937)+" in `$` form.\n"+"UIx doesn't know how to render Reagent components.\n"+"Reagent element should be Hiccup wrapped with r/as-element, i.e. (r/as-element ["+cljs.core.str.cljs$core$IFn$_invoke$arity$1(name_str_17937)+"])")));
} else {
}
...
var and__5160__auto__ = cljs.core.not(x.hasOwnProperty("$$typeof"));
if(and__5160__auto__){
var G__17896 = x;
var G__17896__$1 = (((G__17896 == null))?null:G__17896.constructor);
if((G__17896__$1 == null)){
return null;
} else {
return (G__17896__$1 === Object);
}
} else {
return and__5160__auto__;
}
...
var and__5160__auto__ = ((typeof tag === 'string') || (cljs.core.not(tag.uix_component_QMARK_)));
if(and__5160__auto__){
var and__5160__auto____$1 = props;
...
uix.compiler.alpha.create_element_STAR_ = module$node_modules$react$index.createElement;
uix.compiler.alpha.create_element = (function uix$compiler$alpha$create_element(args,children){
var tag = (args[(0)]);
var props = (args[(1)]);
var child = (args[(2)]);
if(uix.compiler.alpha.js_props_QMARK_(tag,child)){
return module$node_modules$react$index.createElement(tag, Object.assign(props,child), ...children);
} else {
return module$node_modules$react$index.createElement(...args, ...children);
}
});
...
var js_props = (function (){var temp__5827__auto__ = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(props);
if((temp__5827__auto__ == null)){
return ({"value": new cljs.core.Keyword(null,"value","value",305978217).cljs$core$IFn$_invoke$arity$1(props)});
} else {
var key = temp__5827__auto__;
return ({"key": key, "value": new cljs.core.Keyword(null,"value","value",305978217).cljs$core$IFn$_invoke$arity$1(props)});
}
})();
