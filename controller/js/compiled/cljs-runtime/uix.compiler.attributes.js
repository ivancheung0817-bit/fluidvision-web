...
(o[uix.compiler.attributes.cached_prop_name(k)] = (uix.compiler.attributes.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? uix.compiler.attributes.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : uix.compiler.attributes.convert_prop_value.call(null,v)));

return o;
});
uix.compiler.attributes.kv_conv_shallow = (function uix$compiler$attributes$kv_conv_shallow(o,k,v){
(o[uix.compiler.attributes.cached_prop_name(k)] = uix.compiler.attributes.convert_interop_prop_value(k,v));

return o;
});
uix.compiler.attributes.custom_kv_conv = (function uix$compiler$attributes$custom_kv_conv(o,k,v){
(o[uix.compiler.attributes.cached_custom_prop_name(k)] = (uix.compiler.attributes.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? uix.compiler.attributes.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : uix.compiler.attributes.convert_prop_value.call(null,v)));
...
return (function() { 
var G__17839__delegate = function (rest__17737_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,rest__17737_SHARP_);
};
var G__17839 = function (var_args){
var rest__17737_SHARP_ = null;
if (arguments.length > 0) {
var G__17841__i = 0, G__17841__a = new Array(arguments.length -  0);
while (G__17841__i < G__17841__a.length) {G__17841__a[G__17841__i] = arguments[G__17841__i + 0]; ++G__17841__i;}
  rest__17737_SHARP_ = new cljs.core.IndexedSeq(G__17841__a,0,null);
} 
return G__17839__delegate.call(this,rest__17737_SHARP_);};
G__17839.cljs$lang$maxFixedArity = 0;
G__17839.cljs$lang$applyTo = (function (arglist__17842){
var rest__17737_SHARP_ = cljs.core.seq(arglist__17842);
return G__17839__delegate(rest__17737_SHARP_);
});
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__17843__delegate = function (rest__17741_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,rest__17741_SHARP_);
};
var G__17843 = function (var_args){
var rest__17741_SHARP_ = null;
if (arguments.length > 0) {
...
while (G__17845__i < G__17845__a.length) {G__17845__a[G__17845__i] = arguments[G__17845__i + 0]; ++G__17845__i;}
  rest__17741_SHARP_ = new cljs.core.IndexedSeq(G__17845__a,0,null);
} 
return G__17843__delegate.call(this,rest__17741_SHARP_);};
G__17843.cljs$lang$maxFixedArity = 0;
G__17843.cljs$lang$applyTo = (function (arglist__17846){
var rest__17741_SHARP_ = cljs.core.seq(arglist__17846);
return G__17843__delegate(rest__17741_SHARP_);
});
...
var len__5897__auto___17854 = arguments.length;
var i__5898__auto___17855 = (0);
while(true){
if((i__5898__auto___17855 < len__5897__auto___17854)){
args_arr__5922__auto__.push((arguments[i__5898__auto___17855]));

var G__17858 = (i__5898__auto___17855 + (1));
i__5898__auto___17855 = G__17858;
continue;
} else {
}
break;
...
return uix.compiler.attributes.class_names.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__5923__auto__);

}
});

(uix.compiler.attributes.class_names.cljs$core$IFn$_invoke$arity$1 = (function (a){
if(cljs.core.truth_((function (){var or__5162__auto__ = cljs.core.array_QMARK_(a);
if(cljs.core.truth_(or__5162__auto__)){
return or__5162__auto__;
} else {
return cljs.core.coll_QMARK_(a);
}
})())){
...
if(a){
if(b){
return (""+cljs.core.str.cljs$core$IFn$_invoke$arity$1(uix.compiler.attributes.class_names.cljs$core$IFn$_invoke$arity$1(a))+" "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(uix.compiler.attributes.class_names.cljs$core$IFn$_invoke$arity$1(b)));
} else {
...
/** @this {Function} */
(uix.compiler.attributes.class_names.cljs$lang$applyTo = (function (seq17757){
...
return self__5882__auto__.cljs$core$IFn$_invoke$arity$variadic(G__17758,G__17759,seq17757__$2);
}));
...
if(cljs.core.truth_((function (){var and__5160__auto__ = cljs.core.not(cljs.core.re_matches(uix.compiler.attributes.re_tag,tag_str));
...
var vec__17776 = cljs.core.next(cljs.core.re_matches(uix.compiler.attributes.re_tag,tag_str));
var tag__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17776,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17776,(1),null);
var class_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17776,(2),null);
...
var props_class_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(props,new cljs.core.Keyword(null,"class-name","class-name",945142584));
var props_className = cljs.core.get.cljs$core$IFn$_invoke$arity$2(props,new cljs.core.Keyword(null,"className","className",-1983287057));
var id = (id_class[(1)]);
var class$ = (id_class[(2)]);
var class_QMARK_ = (function (){var or__5162__auto__ = class$;
if(cljs.core.truth_(or__5162__auto__)){
return or__5162__auto__;
} else {
var or__5162__auto____$1 = props_class;
if(cljs.core.truth_(or__5162__auto____$1)){
return or__5162__auto____$1;
} else {
var or__5162__auto____$2 = props_class_name;
...
var G__17783 = props;
var G__17783__$1 = (((((!((id == null)))) && ((cljs.core.get.cljs$core$IFn$_invoke$arity$2(props,new cljs.core.Keyword(null,"id","id",-1388402092)) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__17783,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__17783);
if(cljs.core.truth_(class_QMARK_)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__17783__$1,new cljs.core.Keyword(null,"class","class",-2030961996),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"class-name","class-name",945142584),new cljs.core.Keyword(null,"className","className",-1983287057)], 0)),new cljs.core.Keyword(null,"class","class",-2030961996),uix.compiler.attributes.class_names.cljs$core$IFn$_invoke$arity$variadic(class$,props_class,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([props_class_name,props_className], 0)));
} else {
return G__17783__$1;
}
});
