...
var i_16050 = (0);
while(true){
if((i_16050 < arr.length)){
(arr[i_16050] = null);

var G__16051 = (i_16050 + (1));
i_16050 = G__16051;
continue;
} else {
}
...
var i_16063 = (self__.level + (1));
while(true){
if((i_16063 <= (new_level + (1)))){
(update[i_16063] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_16067 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_16067[i]));
} else {
x__$2.forward.push((((i < links_16067.length))?(links_16067[i]):null));
}

if((i < links_16067.length)){
(links_16067[i] = x__$2);
} else {
links_16067.push(x__$2);
}
...
var i_16073 = (0);
while(true){
if((i_16073 <= self__.level)){
var links_16074 = (update[i_16073]).forward;
if((x__$1 === (((i_16073 < links_16074.length))?(links_16074[i_16073]):null))){
(links_16074[i_16073] = (x__$1.forward[i_16073]));

var G__16075 = (i_16073 + (1));
i_16073 = G__16075;
continue;
} else {
var G__16076 = (i_16073 + (1));
i_16073 = G__16076;
continue;
}
} else {
